...
nest.CopyModel('iaf_cond_alpha','pyr', Pyr_params) 
nest.CopyModel('iaf_cond_alpha','pv', PV_params)
...
nest.CopyModel('stdp_synapse','IC',{'alpha':3.0})
...
print 'pref_pref', numpy.mean(numpy.array(p_p)), numpy.std(numpy.array(p_p))
print 'nonpref_pref', numpy.mean(numpy.array(np_p)),numpy.std(numpy.array(np_p))
