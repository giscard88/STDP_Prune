...
fp=open('spikes_psc_alpha'+fn_comm,'r')
spikes=json.load(fp)
fp.close()
...
pylab.savefig('/home/jung/revision/figures/zoom_alpha_pref'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
...
for xi, xin in enumerate(layers):
    ...
    for yin in celltypes:
        ...
        pylab.xlim([0.0,simtime])
    pylab.ylabel(xin)
pylab.savefig('/home/jung/revision/figures/zoom_alpha_nonpref'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
pylab.figure(3)
...
pylab.savefig('/home/jung/revision/figureszoom_alpha_LM'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
