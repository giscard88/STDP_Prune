...
pylab.savefig('/home/jung/revision/figures/raster_pref'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
...
for xi, xin in enumerate(layers):
    ...
    for yin in celltypes:
        ...
        pylab.xlim([0.0,simtime])
    pylab.ylabel(xin)
pylab.savefig('/home/jung/revision/figures/raster_nonpref'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
pylab.figure(3)
...
pylab.savefig('/home/jung/revision/figures/raster_LM'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
