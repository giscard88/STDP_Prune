...
pylab.savefig('../figs/raster_pref'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
...
for xi, xin in enumerate(layers):
    ...
    for yin in celltypes:
        ...
        pylab.xlim([0.0,simtime])
    pylab.ylabel(xin)
pylab.savefig('../figs/raster_nonpref'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
pylab.figure(3)
...
pylab.savefig('../figs/raster_LM'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')

lfp_amp=numpy.array(lfp_data['lfp'])
lfp_amp_mx=numpy.amax(lfp_amp)
lfp_amp=lfp_amp/lfp_amp_mx

pylab.figure(4)
pylab.plot(lfp_data['time'],lfp_amp)
pylab.ylabel('Normalized LFP power')

pylab.savefig('../figs2/lfp_pref'+str(top_down_pyr)+'_'+str(top_down_pv)+'_'+str(msd)+'_'+str(fraction)+'_'+sim_len+'.eps')
