...
pylab.xticks(range(1,len(xv1)+1),test)
pylab.savefig('../figs/'+axis+'_bi_td_'+str(args.top_down_pyr)+'_'+str(args.top_down_pv)+'_'+str(args.second_lgn)+'.eps')
pylab.show()    
